              ...
              <template v-else>
                ...
                <div v-if="isAdmin && message.trace" class="agent-panel">
                  <div class="agent-header">
                    ...
                    <span>{{ actionLabels[message.action] || message.action || '未判断' }}</span>
                  </div>
                  <div class="agent-metrics">
                    <div>
                      <small>意图</small>
                      <b>{{ intentLabels[message.intent] || message.intent || '未识别' }}</b>
                    </div>
                    <div>
                      <small>综合可靠性</small>
                  ...
                  <div class="tool-list">
                    <span v-for="tool in message.trace.used_tools" :key="tool">{{ tool }}</span>
                  </div>
                </div>
